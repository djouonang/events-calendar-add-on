...
if($event_start_date == $event_end_date){
  ...
  echo '<h2 style ="font-size: 15px"><strong>Islamic date:&nbsp;'.getIslamicDate($event_start_date, 1).' &nbsp;'.getIslamicMonth($event_start_month, '2022').'</strong></h2>';
  
}elseif(($event_start_date !== $event_end_date) && ($event_start_month !== $event_end_month)){
  
echo '<h2 style ="font-size: 15px"><strong>Islamic date:&nbsp;From&nbsp;'.getIslamicDate($event_start_date, 1).' &nbsp;'.getIslamicMonth($event_start_month, '2022').'- &nbsp;'.getIslamicDate($event_end_date, 1).' &nbsp;'.getIslamicMonth($event_end_month, '2022').'</strong></h2>';  
 }else{
  
echo '<h2 style ="font-size: 15px"><strong>Islamic date:&nbsp;From&nbsp;'.getIslamicDate($event_start_date, 1).' &nbsp;'.getIslamicMonth($event_start_month, '2022').'- &nbsp;'.getIslamicDate($event_enddate, 1).' &nbsp;'.getIslamicMonth($event_start_month, '2022').'</strong></h2>';  
 }


echo '<h2 style ="font-size: 15px">From:&nbsp;'.$event_start_time.'&nbsp;-&nbsp;'.$event_end_time.'</h2>';  
