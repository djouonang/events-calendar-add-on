		...
		<thead class="tribe-mini-calendar-nav">
			<tr>
				<td colspan="7">
					...
					<span id="tribe-mini-calendar-month"><?php //tribe_events_the_mini_calendar_title();
					echo " and <span class='islamic-date'>".getIslamicMonth($the_date->format( 'F' ), '2014')."</span>"?></span>
